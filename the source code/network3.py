...
class MetricNet(nn.Module):
    ...
    def forward_1(self,Re_s=None, Im_s=None,omega=None):##lnf(z) forward
    ...
    def forward_6(self,Re_s=None, Im_s=None,omega=None):##f and f'/f=D
        for j in range(1,self.N_layers+1):
            ...
            '''
        return Re_s,Im_s
    def loss(self, Re_i=None, Im_i=None, Re_f=None,Im_f=None,omega=None, reg_coef_list=None):
        
        criterion=torch.nn.L1Loss()
        #criterion = torch.nn.MSELoss(reduction='sum')
        model_outputRe,  model_outputIm= self.forward_1(Re_s=Re_i, Im_s=Im_i,omega=omega) 
    ...
    def loss_2(self, Re_i=None, Im_i=None, Re_f=None,Im_f=None,omega=None, reg_coef_list=None):
    ...
    def loss_3(self, Re_i=None, Im_i=None, Re_f=None,Im_f=None,omega=None):
        criterion = torch.nn.L1Loss()
        model_outputRe,  model_outputIm= self.forward_1(Re_s=Re_i, Im_s=Im_i,omega=omega) 
        #print('model_outputRe:',model_outputRe[0][0])
        loss = criterion(model_outputRe, Re_f)+criterion(model_outputIm, Im_f)
